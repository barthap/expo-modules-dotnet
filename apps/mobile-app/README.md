...
This app is an experiment under `experiments/mobile-app`, not a production
mobile adapter. It validates the NativeAOT / React Native adapter seam while
leaving production lifecycle work, especially reload-safe teardown, for future
roadmap items.
