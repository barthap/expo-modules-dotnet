...
- **Execution status**: COMPLETE — implemented at `be4ac86f`, `dc526e83`,
  `819d8622`, and `b21f3d9b`. macOS and Docker Linux HostFXR/NativeAOT proofs,
  managed tests, formatting, and workflow lint passed.
