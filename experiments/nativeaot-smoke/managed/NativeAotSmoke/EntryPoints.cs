...
public static unsafe class EntryPoints
{
  ...
  [UnmanagedCallersOnly(EntryPoint = "nativeaot_smoke_get_message", CallConvs = new[] { typeof(CallConvCdecl) })]
  ...
  [UnmanagedCallersOnly(EntryPoint = "nativeaot_smoke_release_message", CallConvs = new[] { typeof(CallConvCdecl) })]
