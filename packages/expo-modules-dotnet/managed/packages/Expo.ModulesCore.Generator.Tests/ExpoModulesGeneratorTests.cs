...
public sealed class ExpoModulesGeneratorTests
{
  ...
  public void GeneratorEmitsDeterministicProviderForAssembly()
  {
    ...
    Assert.Contains(
        "public static void Register(global::Expo.JSI.JavaScriptRuntime runtime, global::Expo.JSI.JavaScriptObject modules)",
        source
    );
    Assert.DoesNotContain("public static void Register(global::Expo.JSI.JavaScriptRuntime runtime)", source);
    Assert.Contains("ModuleRegistry.DefineModule(runtime, modules, \"Math\")", source);
  }
