...
public sealed class ExpoModulesGenerator : IIncrementalGenerator
{
      ...
      CancellationToken cancellationToken)
  {
    ...
    {
      AddDeclarationDiagnostic("it must be a class");
    }
    ...
    events = GetTypedEvents(
        ...
        isDeclarationValid ? null : "declared on an invalid Expo shared object class"
    );
    ...
    return new ExpoSharedObjectModel(
        ...
        GetTypeDeclarationKind(context.TargetNode),
        javaScriptClassName,
        location,
        isDeclarationValid,
        constructor,
