...
type LinkPlatform = StagePlatform;
...
export function resolvePlatform(platform: string | undefined): LinkPlatform {
  if (platform === undefined || !supportedPlatforms.has(platform)) {
    throw new Error(
      `[expo-modules-dotnet-autolinking] Unsupported link platform ${platform}. Use macos, windows, ios, or android.`
    );
  }
